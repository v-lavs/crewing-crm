...
!function (t, e) {
  ...
  'initCustomEvent' in e.createEvent('CustomEvent') && (t.CustomEvent = function (t, n) {
    ...
    l = t.target, i = Date.now(), n = t.touches[0].clientX, u = t.touches[0].clientY, a = 0, o = 0;
  }, !1), e.addEventListener('touchmove', function (t) {
    if (!n || !u) return;
    var e = t.touches[0].clientX, i = t.touches[0].clientY;
    a = n - e, o = u - i;
  }, !1), e.addEventListener('touchend', function (t) {
    if (l !== t.target) return;
    var e = parseInt(l.getAttribute('data-swipe-threshold') || '20', 10),
      s = parseInt(l.getAttribute('data-swipe-timeout') || '500', 10), r = Date.now() - i, c = '';
    Math.abs(a) > Math.abs(o) ? Math.abs(a) > e && r < s && (c = a > 0 ? 'swiped-left' : 'swiped-right') : Math.abs(o) > e && r < s && (c = o > 0 ? 'swiped-up' : 'swiped-down');
    '' !== c && (l.dispatchEvent(new CustomEvent(c, {
      bubbles: !0,
      cancelable: !0
    })));
    n = null, u = null, i = null;
  }, !1);
  var n = null, u = null, a = null, o = null, i = null, l = null;
}(this, document);